...
export function CvMatchPanel() {
  ...
  async function submitUpload(event: React.FormEvent<HTMLFormElement>) {
    ...
    setNotice(dictionary.cv.profileCreated);
    setBusy(false);
  }
  ...
  async function refreshMatches() {
    ...
    setNotice(dictionary.cv.matchesRefreshed);
    setBusy(false);
  }
  ...
  async function removeProfile() {
    ...
    setGeneration(null);
    setMatches([]);
    setNotice(dictionary.cv.deleted);
    setBusy(false);
  }
