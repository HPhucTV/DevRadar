...
export function IngestionConsole() {
  ...
  return <div className="operations-workspace">
    <section className="operations-summary glass-surface source-health-intro">
    ...
    <div className="operations-summary metrics-layout health-grid">
    ...
    <section className="operations-list data-surface glass-surface">
