...
focused và final-repeat gates đã pass; full Compose/browser/secret/supply-chain evidence cùng closeout được
ghi tại [V6-025 evidence](evidence/V6-025-source-terms-hard-cut-job-visibility.md). Public HTTPS/provider,
managed secrets và off-host backup/RPO/RTO vẫn là gate V6 riêng, không bị closeout này thay đổi.
