...
| Runtime/test evidence | [V1-001 scaffold](evidence/V1-001-scaffold.md), [V1-002 PostgreSQL schema](evidence/V1-002-postgresql-schema.md), [V1-003 source registry](evidence/V1-003-source-registry.md), [V1-005 normalization](evidence/V1-005-normalization-and-hashing.md); chưa có crawler/domain API |
...
Evidence hiện có: [V1-001 scaffold](evidence/V1-001-scaffold.md), [V1-002 PostgreSQL schema](evidence/V1-002-postgresql-schema.md), [V1-003 source registry](evidence/V1-003-source-registry.md) và [V1-005 normalization](evidence/V1-005-normalization-and-hashing.md). Đây chưa phải V1 exit evidence.
