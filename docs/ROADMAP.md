...
| Runtime/test evidence | V1 [complete](evidence/V1-closeout.md); V2 [complete](evidence/V2-006-v2-closeout.md); V3 có [evaluation baseline](evidence/V3-001-evaluation-dataset-and-baseline.md) và [provider/pgvector spike](evidence/V3-002-provider-privacy-cost-pgvector-spike.md) đang blocked ở live credential gate |
