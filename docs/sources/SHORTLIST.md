...
**Phạm vi:** job IT công khai tại Việt Nam

**Trạng thái:** discovery hoàn tất; approval outcome hiện tại là `3 approved`, `3 permission_required/hold` và `2 rejected_for_v1`
...
Ba source V1 được duyệt là VNG Careers, NAVER Vietnam/Greenhouse và MoMo Careers. GeoComply/Lever không thuộc V1 cho tới khi `permission_required` được giải quyết bằng evidence mới.
